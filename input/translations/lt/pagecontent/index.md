...
- **Sąveikumą:** Palengvinti **vientisą, semantinį** su gyvensena ir patikra susijusių duomenų mainus tarp **Elektroninių sveikatos įrašų (ESI)**, **pacientų portalų**, **patikros sistemų**, **mokslinių tyrimų platformų** ir **visuomenės sveikatos registrų**.
- **Duomenų kokybę:** Pagerinti užfiksuotų stebėjimų ir **iš klausimynų gautų duomenų** **nuoseklumą**, **išsamumą** ir **palyginamumą** naudojant **standartizuotas struktūras**, **duomenų tipus** ir **terminologijos susiejimus**.
- **Klinikinę naudą:** Palaikyti **prevenciją**, **rizikos įvertinimą**, **patikros darbo eigas**, **klinikinį sprendimų palaikymą** ir **populiacijos sveikatos analizę**, padarant su gyvensena susijusią informaciją prieinamą **struktūrizuota ir daugkartinio naudojimo forma**.
