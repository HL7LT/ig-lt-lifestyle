...
ValueSet: AlcoholUseFrequencyVS
...
* ^experimental = false
* ^publisher = "HL7 Lithuania"
* $sct#69620002  "Daily (qualifier value)"
* $sct#14497002 "Weekly (qualifier value)"
* $sct#89185003 "Monthly (qualifier value)"
...
InstanceOf: LTAlcoholUseHistory
Usage: #example
